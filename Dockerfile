...
# This is needed to be able to build on QEMU for OTP 25+
# QEMU is used with docker buildx for multi-arch builds (including AMD64)
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/adbc_docker_sample_project ./
